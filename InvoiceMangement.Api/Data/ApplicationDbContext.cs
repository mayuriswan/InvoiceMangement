    ...
    public class ApplicationDbContext : DbContext
    {
       ...
       .HasForeignKey(i => i.CategoryID);
        ...
        public void Seed()
        {
            ...
            if (!Categories.Any())
            {
                // Predefined categories to be inserted with explicit IDs
                var categories = new[]
                {
            ...
            new Category { CategoryCode = "Laptops   ", CategoryDescription = "Laptops" }
                ...
                SaveChanges();  // Save changes to ensure CategoryIDs are stored
            }
            ...
            new Invoice
            {
                ...
                CategoryID = 1, // References 'Servers'
                CustomerID = "456",
                TotalAmount = 1500,
            ...
            new Invoice
            {
                ...
                CategoryID = 2, // References 'Software'
                CustomerID = "IBM",
                TotalAmount = 5000,
            ...
            new Invoice
            {
                InvoiceNumber = "40002",
                InvoiceDate = DateTime.Parse("2024-05-16"),
                CategoryID = 4, // References 'Laptops'
